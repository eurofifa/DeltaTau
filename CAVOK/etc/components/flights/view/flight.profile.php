        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td class="td-head" colspan="8" style="text-align: right; line-height: 50px;">
                    In case of inaccuracy, please report this flight: 
                    <a href="/flights/report/<?php echo $item['ID']; ?>" class="btn btn-lightred">Report Flight</a>
                    <?php if(ACL::is_extended('flights')): ?>
                    |
                    <a href="/flights/edit/<?php echo $item['ID']; ?>" class="btn btn-blue">Edit Flight</a>
